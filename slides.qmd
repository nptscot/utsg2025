...
## Authors
- Robin Lovelace, Zhao Wang, Hussein Mahfouz, Juan Jose Fonseca Zamora, Martin Lucas-Smith, Dustin Carlino, Angus Calder, Congying Hu, Michael Naysmith, Matthew Davis
...
- Traditional transport models rely on limited datasets, leading to biases and blind spots.
...
- Historic models focus on commuting and simplified networks, missing active travel and non-work trips.
- Recent tools often focus on either behaviour or infrastructure, limiting scope.
...
- Builds on prior work (e.g., CRUSE tool) and integrates infrastructure and behavioural data.
...
# Figures: Cycle Infrastructure & Street Space
...
# References
- See full paper and bibliography for details.